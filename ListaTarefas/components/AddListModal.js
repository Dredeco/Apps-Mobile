...
import { View, Text, StyleSheet, KeyboardAvoidingView, Pressable, TextInput } from "react-native"
    ...
    render () {
        return (
            <KeyboardAvoidingView style={styles.container} behavior="padding">
                <Pressable style={{ position: "absolute", top: 64, right: 32 }} onPress={this.props.closeModal}>
