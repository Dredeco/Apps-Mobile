...
import { View, Text, StyleSheet, SafeAreaView, Pressable, FlatList, KeyboardAvoidingView, TextInput, Animated, Keyboard } from "react-native";
        ...
        return (
            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={[styles.section, styles.footer]}>
                    ...
                    />
                    <Pressable style={[styles.addTodo, { backgroundColor: list.color }]} onPress={() => this.addTodo()}>
