 ...
 class Food extends Component {
      ...
      <ScrollView>
        <View style={{flex:1, backgroundColor:"black" }}>
          ...
          <TouchableOpacity onPress={()=>this.setState({module:2})}>
              <Image style={{height:90,width:90,margin:10, marginTop:5 }} resizeMode="contain" source={require("../image/foodapp.png")}  />
          </TouchableOpacity>
  ...
  _renderItem(item){
    return(
      ...
      style={{marginLeft: 3.5, flexDirection: "column", paddingLeft: 10}}>
        <Image
          style={{width:80, height:80, borderColor:'red', borderWidth:2, borderRadius:100}}
          resizeMode="cover"
          source={item.image} />
      ...
      return(
        <TouchableOpacity style={styles.divFood}>
          <Image
            ...
            <View style={{width:1}} />
            <Text style={{fontSize:12, color:"white", fontWeight:"bold"}}>Adicionar ao carrinho</Text>
          </TouchableOpacity>
